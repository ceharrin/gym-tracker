...
enum CoreDataTestHelper {
    ...
    /// NSPersistentContainer the production app uses. This ensures tests
    /// exercise the real stack (merge policies, model version, etc.) rather
    /// than a divergent ad-hoc container.
